...
public class RestPoductController {
	...
	public ResponseEntity<Map<String,Object>> productReg(ProductDTO dto) throws MyException {
	...
	public ResponseEntity<Map<String,Object>> productUpdate(ProductDTO product) {
		ResponseEntity<Map<String,Object>> resEntity = null;
		try {
